...
AGENTS = {
    ...
    "luna_opportunity_scout": "Low-cost discovery and triage of current AI awards, project calls, presentations, and grants.",
    ...
    "sol_grants_researcher": "Complex eligibility, funding, state-aid, impact, and call-document analysis for AI opportunities.",
    ...
    "astra_submission_auditor": "Exceptional final audit of eligibility, evidence, forms, declarations, and submission readiness.",
